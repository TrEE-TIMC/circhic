"""
==============================================
Plotting a circular heatmap of *C. crescentus*
==============================================

Small example showing a square contact count map of *C. crescentus* versus the
circular equivalent.
"""
...
plt.subplot(1, 2, 1)
plt.imshow(counts, norm=colors.SymLogNorm(min_non_zero), vmin=vmin, vmax=vmax,
           cmap='viridis')
